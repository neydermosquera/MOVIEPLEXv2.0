        ...
        <div class="col-md-12">
            <div class="card" style="background-color: transparent;">
                ...
                <div class="card-body">
                    ...
                    <H1 style="text-align: center; color: white;">¿Qué quieres hacer hoy?</H1> 
                    ...
                    <div class="botones">
                        ...
                        <div class="card" style="width: 18rem; margin-left: 5%; margin-top: 2%; background: #1B2631;">
                            <div class="card-body">
                                ...
                                <a href="{{ url('/salas') }}" class="btn" style="width: 100%; background: #16A085; color:white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm6.5-11a.5.5 0 0 0-1 0V6H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V7H10a.5.5 0 0 0 0-1H8.5V4.5z"/>
                        ...
                        <div class="card" style="width: 19rem; margin-left: 5%; margin-top: 2%; background: #1B2631;">
                            <div class="card-body">
                                ...
                                <a href="{{ url('users') }}" class="btn" style="width: 100%; background: #16A085; color:white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-plus-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm6.5-11a.5.5 0 0 0-1 0V6H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V7H10a.5.5 0 0 0 0-1H8.5V4.5z"/>
